...
Pod::Spec.new do |s|
  ...
  s.homepage     = "https://github.com/MHeeres/Bean-iOS-OSX-SDK"
  ...
  s.source       = { :git => "--recursive https://github.com/MHeeres/Bean-iOS-OSX-SDK.git", :tag => s.version.to_s, :submodules => true, :branch => 'batteryLevel' }
